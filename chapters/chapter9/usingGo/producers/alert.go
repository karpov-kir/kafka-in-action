...
var interceptors []ProducerInterceptor = []ProducerInterceptor{&DefaultProducerInterceptor{}}

func ProduceAlertData(bootstrapServers string) {
		...
		for event := range producer.Events() {
			...
			case *kafka.Message:
				for _, interceptor := range interceptors {
					interceptor.OnAcknowledgement(typedEvent)
				}
